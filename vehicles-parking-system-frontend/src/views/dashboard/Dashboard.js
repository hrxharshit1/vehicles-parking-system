            ...
            <CCardBody>
              ...
              <CRow className="mb-3 justify-content-between align-items-center">
                <CCol md="6">
                  <CFormInput
                    type="text"
                    placeholder="Search vehicle no , slot id ..."
                    className="search-input"
                  />
                </CCol>
                <CCol md="auto">
                  <CButton color="danger" className="exit-button">
                    Exit
                  </CButton>
                </CCol>
              </CRow>
              <CTable
                align="middle"
                className="mb-0 border custom-parking-table table-striped table-hover table-bordered text-center"
                hover
                responsive
              >
                <CTableHead className="bg-light fw-semibold text-uppercase text-primary #fa2742">
                  <CTableRow>
                    {/* <CTableHeaderCell>ID</CTableHeaderCell>
                    <CTableHeaderCell>Place ID</CTableHeaderCell> */}
                    <CTableHeaderCell>Slot ID</CTableHeaderCell>
